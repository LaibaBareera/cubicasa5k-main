import math
import numpy as np
from floortrans.loaders.svg_utils import PolygonWall, get_polygon, calc_distance, get_room_number, get_points, get_direction, get_gaussian2D
...
class House:
    def __init__(self, path, height, width, room_list=rooms_selected):
        self.height = height
        self.width = width
        shape = height, width
    ...
    def get_tensor(self):
        ...
        tensor = np.concatenate((heatmaps, wall_t), axis=0)
